...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DE0_NANO_MTL2_Painter.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../MTL2.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8000050
SOPC_SYSID_FLAG += --sidp=0x8000050
ELF_PATCH_FLAG  += --sidp 0x8000050

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1406868601
SOPC_SYSID_FLAG += --timestamp=1406868601
ELF_PATCH_FLAG  += --timestamp 1406868601
