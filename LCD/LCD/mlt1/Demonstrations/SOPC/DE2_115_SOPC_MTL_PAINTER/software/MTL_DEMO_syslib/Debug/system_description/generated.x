 ...
 *
 * Generated: 2011-10-25 14:15:33.492
 *
 */
...
MEMORY
{
    reset : ORIGIN = 0x02000000, LENGTH = 32
    sdram : ORIGIN = 0x08000000, LENGTH = 134217728
    sram_UNUSED : ORIGIN = 0x00400000, LENGTH = 32
    sram : ORIGIN = 0x00400020, LENGTH = 2097120
    cfi_flash : ORIGIN = 0x02000020, LENGTH = 8388576
    epcs_flash_controller : ORIGIN = 0x00000000, LENGTH = 2048
}

    /* Define symbols for each memory base-address */
 __alt_mem_sdram = 0x08000000 ;
 __alt_mem_sram = 0x00400000 ;
 __alt_mem_cfi_flash = 0x02000000 ;
 __alt_mem_epcs_flash_controller = 0x00000000 ;
...
PROVIDE( __alt_heap_limit    = 0x00600000 );
