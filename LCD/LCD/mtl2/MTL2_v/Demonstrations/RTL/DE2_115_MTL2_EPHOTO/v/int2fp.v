...
module  int2fp_altbarrel_shift_tvf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //int2fp_altbarrel_shift_tvf


//altpriority_encoder CBX_AUTO_BLACKBOX="ALL" WIDTH=32 WIDTHAD=5 data q
//VERSION_BEGIN 10.1SP1 cbx_altpriority_encoder 2011:01:19:21:13:40:SJ cbx_mgl 2011:01:19:21:15:40:SJ  VERSION_END
...
module  int2fp_altpriority_encoder_6e8
	...
	int2fp_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder15_q),
	.zero(wire_altpriority_encoder15_zero));
	int2fp_altpriority_encoder_3e8   altpriority_encoder16
	( 
	.data(data[3:2]),
...
module  int2fp_altpriority_encoder_be8
	...
	int2fp_altpriority_encoder_6e8   altpriority_encoder13
	( 
	.data(data[3:0]),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2fp_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	int2fp_altpriority_encoder_be8   altpriority_encoder11
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	int2fp_altpriority_encoder_be8   altpriority_encoder12
	( 
	.data(data[15:8]),
...
endmodule //int2fp_altpriority_encoder_rf8
...
module  int2fp_altpriority_encoder_6v7
	...
	int2fp_altpriority_encoder_3v7   altpriority_encoder21
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder21_q));
	int2fp_altpriority_encoder_3e8   altpriority_encoder22
	( 
	.data(data[3:2]),
...
module  int2fp_altpriority_encoder_bv7
	...
	int2fp_altpriority_encoder_6v7   altpriority_encoder19
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder19_q));
	int2fp_altpriority_encoder_6e8   altpriority_encoder20
	( 
	.data(data[7:4]),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2fp_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	int2fp_altpriority_encoder_bv7   altpriority_encoder17
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder17_q));
	int2fp_altpriority_encoder_be8   altpriority_encoder18
	( 
	.data(data[15:8]),
...
endmodule //int2fp_altpriority_encoder_r08

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2fp_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	int2fp_altpriority_encoder_rf8   altpriority_encoder10
	( 
	.data(data[31:16]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	int2fp_altpriority_encoder_r08   altpriority_encoder9
	( 
	.data(data[15:0]),
...
endmodule //int2fp_altpriority_encoder_qb6

//synthesis_resources = lpm_add_sub 5 lpm_compare 1 reg 247 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2fp_altfp_convert_l1n
	( 
	clock,
	dataa,
	result) ;
	...
	int2fp_altbarrel_shift_tvf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	int2fp_altpriority_encoder_qb6   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
...
endmodule //int2fp_altfp_convert_l1n
//VALID FILE
...
module int2fp (
	...
	int2fp_altfp_convert_l1n	int2fp_altfp_convert_l1n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL int2fp.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL int2fp_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL int2fp_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL int2fp.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL int2fp.cmp FALSE TRUE
