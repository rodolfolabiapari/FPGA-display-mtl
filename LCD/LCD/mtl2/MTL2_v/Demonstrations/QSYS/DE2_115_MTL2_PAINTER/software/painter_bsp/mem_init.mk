...
MEM_1 := DE2_115_SOPC_epcs_flash_controller_boot_rom
$(MEM_1)_NAME := epcs_flash_controller
...
$(MEM_1)_HIERARCHICAL_PATH := epcs_flash_controller
$(MEM_1)_WIDTH := 32
...
epcs_flash_controller: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym $(MEM_1).flash
