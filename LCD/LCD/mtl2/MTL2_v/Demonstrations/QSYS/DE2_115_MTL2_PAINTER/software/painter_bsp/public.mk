...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../Painter.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1000060
SOPC_SYSID_FLAG += --sidp=0x1000060
ELF_PATCH_FLAG  += --sidp 0x1000060

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1406857615
SOPC_SYSID_FLAG += --timestamp=1406857615
ELF_PATCH_FLAG  += --timestamp 1406857615
