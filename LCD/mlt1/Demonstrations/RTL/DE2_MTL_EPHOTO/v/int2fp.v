...
module  int2fp_altbarrel_shift_brf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //int2fp_altbarrel_shift_brf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2fp_altfp_convert_3tm
	( 
	clock,
	dataa,
	result) ;
	...
	int2fp_altbarrel_shift_brf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //int2fp_altfp_convert_3tm
//VALID FILE
...
module int2fp (
	...
	int2fp_altfp_convert_3tm	int2fp_altfp_convert_3tm_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
