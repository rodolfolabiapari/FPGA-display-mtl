...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone II" OPERATION="FLOAT2FIXED" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=10 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=17 clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone II" PIPELINE=2 SHIFTDIR="VARIABLE" SHIFTTYPE="LOGICAL" WIDTH=39 WIDTHDIST=6 aclr clk_en clock data direction distance result
...
module  fp2int_altbarrel_shift_f7h
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp2int_altbarrel_shift_f7h

//synthesis_resources = lpm_add_sub 6 lpm_compare 4 reg 222 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp2int_altfp_convert_73n
	( 
	clock,
	dataa,
	result) ;
	...
	fp2int_altbarrel_shift_f7h   altbarrel_shift2
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fp2int_altfp_convert_73n
//VALID FILE
...
module fp2int (
	...
	fp2int_altfp_convert_73n	fp2int_altfp_convert_73n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
